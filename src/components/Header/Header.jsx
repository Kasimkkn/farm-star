        ...
        <div className="container-fluid bg-white fixed-top px-0">
            <div className="top-bar row gx-0 align-items-center d-none d-lg-flex">
                ...
                <div className="col-lg-3 px-5 text-end">
                    <span>Follow us:</span>
                    <Link className="text-body ms-3" to="https://www.facebook.com/people/Asgar-Ali-Bhura/pfbid02DHzYyHs3RvXdVXrTauqNn5FctRQsBupmcKNduhfPFMyt2Ny81JeBjDd147j7HkFVl/?mibextid=ZbWKwL"><FaFacebook className='me-2 fa-facebook-f' /></Link>
                    <Link className="text-body ms-3" to="https://www.instagram.com/farm_star_services?igsh=MTNxMDI3NWV4cGZzMA%3D%3D"><FaInstagram className='me-2 fa-instagram' /></Link>
                </div>
            </div>
